...
namespace GenericObjects
{
    ...
    public class WebcamCapture : System.Windows.Forms.UserControl, IWebcamCapture
    {
            ...
            finally
            {
                try
                {
                    if (!_webcamClosed)
                    {
                        ...
                        WebcamWin32APIMethods.SendMessage(_captureWindowHandler, WebcamWin32APIConstants.WM_CAP_DISCONNECT, IntPtr.Zero, IntPtr.Zero);
                        _webcamClosed = true;
                    }
                }
                catch { } 
