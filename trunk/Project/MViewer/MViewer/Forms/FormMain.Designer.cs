...
namespace MViewer
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.contactsControl = new UIControls.ContactsControl(this.OnContactsControl_ClosePressed,
                this.OnContactsUpdated, this.OnSelectedContactChanged);

            this.identityControl = new UIControls.IdentityControl();
            this.identityControl = new UIControls.IdentityControl(this.OnIdentityUpdated,
